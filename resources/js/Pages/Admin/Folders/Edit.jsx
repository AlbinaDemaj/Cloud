...
export default function Edit({
    ...
    const { data, setData, processing, errors } = useForm({
        ...
        name: folder?.name || '',
        is_visible: Boolean(folder?.is_visible),
    });
    ...
    const filteredGuests = guests.filter((guest) => {
        ...
        return Number(guest.company_id) === Number(data.company_id);
    });
            ...
            <div className="mx-auto max-w-3xl">
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-slate-500">
                        Update folder details, company assignment and visibility.
                    </p>
                </div>
